...
ControlPidTypedef SpeedControlPid = {15.0,5,0.0};   //速度控制pid参数初始化
ControlPidTypedef AngleControlPid = {4.2, 0, 25};       //角度pid参数
ControlPidTypedef PositionControlPid = {0.09,0, 0}; //位置pid参数
ControlPidTypedef CorrectControlPid={0.4,0,0.2};        //矫正pid参数
...
coordinateTypedef orignal_pos = {0, 0};                //初始位置值
